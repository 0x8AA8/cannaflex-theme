            ...
            {else}
              ...
              >
                {if $page.type === 'previous'}
                  <i class="material-icons">&#xE314;</i><span class="hidden">{l s='Previous' d='Shop.Theme.Actions'}</span>
                {elseif $page.type === 'next'}
                  <span class="hidden">{l s='Next' d='Shop.Theme.Actions'}</span><i class="material-icons">&#xE315;</i>
                {else}
                  {$page.page}
                {/if}
              </a>
