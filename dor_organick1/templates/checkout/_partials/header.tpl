    ...
    {if $smarty.capture.dorHeaderSearch}
      <div class="dorHeaderSearch-Wapper clearfix">
        <div class="container-fluid">
          <div class="row">{$smarty.capture.dorHeaderSearch nofilter}</div>
        </div>
      </div>
    {/if}
    <nav class="header-nav">
      <div class="container">
        <div class="row">
          ...
          <div class="top-logo col-md-6" id="_mobile_logo"></div>
          <div class="head-dorsetting pull-right">
            {block name='header_nav'}
              <nav class="header-nav-button">
                <div class="hidden-sm-down-">
                  <div class="right-nav">
                      <div class="nav-search-button"><button type="button"><i class="pe-7s-search"></i></button></div>
                      <div class="nav-group user-info selection-options-wrapper">
                        <button type="button" class="hidden"><i class="pe-7s-user"></i></button>
                        {hook h='displayNav1'}
                      </div>
                      <div class="nav-cart">
                      {hook h='displayNav2'}
