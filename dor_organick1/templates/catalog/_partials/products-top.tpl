  ...
  <div class="clearfix">
    <div class="dor-display-cate">
      <div class="show-display-control">
        ...
        <a href="#" rel="nofollow" class="displayList {if isset($dorCategoryShow) && $dorCategoryShow =='list'} active{/if}" data-id="list" data-toggle="tooltip" data-placement="top" title="" data-original-title="List"><i class="material-icons">&#xE8EF;</i></a>
      </div>
    </div>
