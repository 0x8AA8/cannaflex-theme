...
<div id="recent_article_smart_blog_block_left"  class="block blogModule boxPlain">
   <div class="section-title"><h2 class="title_block"><a href="{smartblog::GetSmartBlogLink('smartblog')}">{l s='Popular Posts' d='Modules.Smartblogpopularposts.Shop'}</a></h2></div>
