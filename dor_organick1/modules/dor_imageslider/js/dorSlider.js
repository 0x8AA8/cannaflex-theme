jQuery(document).ready(function () {
    var checkSlider = $("#dorSlideShow").html();
    if(typeof checkSlider == "undefined") return false;
    var jssor_1_SlideshowTransitions = [];
    if(parseInt($( window ).width()) > 767 && DORSLIDER.effect == 1){
      var jssor_1_SlideshowTransitions = [
        //{$Duration:1000,$Delay:80,$Cols:8,$Rows:4,$Clip:15,$SlideOut:true,$Easing:$Jease$.$OutQuad},
        {$Duration:350,y:0.3,$Cols:2,$During:{$Top:[0.3,0.7]},$ChessMode:{$Column:12},$Easing:{$Top:$Jease$.$InCubic,$Opacity:$Jease$.$Linear},$Opacity:2},
        {$Duration:350,x:-1,y:2,$Rows:2,$Zoom:11,$Rotate:1,$SlideOut:true,$Assembly:2049,$ChessMode:{$Row:15},$Easing:{$Left:$Jease$.$InExpo,$Top:$Jease$.$InExpo,$Zoom:$Jease$.$InExpo,$Opacity:$Jease$.$Linear,$Rotate:$Jease$.$InExpo},$Opacity:2,$Round:{$Rotate:0.85}},
        {$Duration:350,x:4,$Cols:2,$Zoom:11,$SlideOut:true,$Assembly:2049,$ChessMode:{$Column:15},$Easing:{$Left:$Jease$.$InExpo,$Zoom:$Jease$.$InExpo,$Opacity:$Jease$.$Linear},$Opacity:2},
        {$Duration:350,x:4,y:-4,$Zoom:11,$Rotate:1,$SlideOut:true,$Easing:{$Left:$Jease$.$InExpo,$Top:$Jease$.$InExpo,$Zoom:$Jease$.$InExpo,$Opacity:$Jease$.$Linear,$Rotate:$Jease$.$InExpo},$Opacity:2,$Round:{$Rotate:0.8}},
        ...
        {$Duration:350,x:-3,y:1,$Rows:2,$Zoom:11,$Rotate:1,$SlideOut:true,$Assembly:2049,$ChessMode:{$Row:28},$Easing:{$Left:$Jease$.$InExpo,$Top:$Jease$.$InExpo,$Zoom:$Jease$.$InExpo,$Opacity:$Jease$.$Linear,$Rotate:$Jease$.$InExpo},$Opacity:2,$Round:{$Rotate:0.7}},
        {$Duration:350,y:-1,$Cols:8,$Rows:4,$Clip:15,$During:{$Top:[0.5,0.5],$Clip:[0,0.5]},$Formation:$JssorSlideshowFormations$.$FormationStraight,$ChessMode:{$Column:12},$ScaleClip:0.5},
        {$Duration:350,x:0.5,y:0.5,$Zoom:1,$Rotate:1,$SlideOut:true,$Easing:{$Left:$Jease$.$InCubic,$Top:$Jease$.$InCubic,$Zoom:$Jease$.$InCubic,$Opacity:$Jease$.$Linear,$Rotate:$Jease$.$InCubic},$Opacity:2,$Round:{$Rotate:0.5}},
        {$Duration:350,x:-0.6,y:-0.6,$Zoom:1,$Rotate:1,$During:{$Left:[0.2,0.8],$Top:[0.2,0.8],$Zoom:[0.2,0.8],$Rotate:[0.2,0.8]},$Easing:{$Zoom:$Jease$.$Swing,$Opacity:$Jease$.$Linear,$Rotate:$Jease$.$Swing},$Opacity:2,$Round:{$Rotate:0.5}},
        ...
        {$Duration:350,$Delay:20,$Clip:3,$SlideOut:true,$Assembly:260,$Easing:{$Clip:$Jease$.$OutCubic,$Opacity:$Jease$.$Linear},$Opacity:2}
      ];
    }
    ...
    var DorSlideoTransitions = [
      ...
      [{b:-1,d:1,o:-1},{b:1200,d:800,x:410,o:1,e:{x:27,o:6}}],
      [{b:-1,d:1,o:-1},{b:2000,d:600,x:200,y:-100,o:1,e:{x:3,y:3}}],
      [{b:4600,d:960,x:-204}],
      ...
      [{b:-1,d:1,sX:-1,sY:-1},{b:500,d:400,sX:1.33,sY:1.33,e:{sX:7,sY:7}},{b:1000,d:200,sX:-0.33,sY:-0.33,e:{sX:16,sY:16}}],
      ...
      [{b:-1,d:1,sX:-1,sY:-1},{b:1000,d:400,x:0,sX:1.33,sY:1.33,e:{sX:7,sY:7}},{b:1300,d:200,sX:-0.33,sY:-0.33,e:{sX:16,sY:16}}],//83
      ...
      [{b:-1,d:1,o:-1},{b:1600,d:800,x:410,o:1,e:{x:27,o:6}}],//87
      [{b:-1,d:1,o:-1},{b:0,d:800,x:-410,o:1,e:{x:27,o:6}}], //88
      [{b:-1,d:1,sX:-1,sY:-1},{b:800,d:400,x:-126,sX:1.33,sY:1.33,e:{sX:7,sY:7}},{b:1500,d:0,sX:-0.33,sY:-0.33,e:{sX:16,sY:16}}]//89
    ];
    var _SlideshowTransitions = [
        { $Duration: 9000, $Opacity: 2 }
    ];
    var dorSliderOptions = {
      $PauseOnHover:DORSLIDER.pause,
      $AutoPlay: DORSLIDER.autoplay,
      $SlideDuration: DORSLIDER.speed,
      $Loop: DORSLIDER.wrap,
    ...
    dor_slider.$On( $JssorSlider$.$EVT_PARK, function(slideIndex){
        var allImages = $(dor_slider.$Elmt).find("img[data-u=image]");
        var currentImage = allImages.eq(slideIndex);
        var currentDiv = currentImage.parent("div");
        //currentDiv.addClass("current");
        setTimeout(function(){
          $(".slide-item-"+(slideIndex+1)).addClass("current");
        },300);
    });
    
    // event fired when slider starts moving
    dor_slider.$On( $JssorSlider$.$EVT_POSITION_CHANGE, function(position){
        
        // remove 'current' class from all slides
        $(dor_slider.$Elmt).find(".current").removeClass("current");       
        
    });
  /*  $("body").on("mouseout",".slide-item-2.current",function(){
        $(".slide-item-2.current .product-item-image").addClass("go");
    });
    $("body").on("mouseover",".slide-item-2.current",function(){
        $(".slide-item-2.current .product-item-image").removeClass("go");
    })*/
