 ...
 */
{
	...
	class GridItem {
		...
		setTransform(transform) {
			...
			//this.DOM.el.style.animation = `none`;
		}
		isNavCtrl() {
	...
	class Grid {
		constructor(el, options) {
			...
			this.DOM = {};
			this.DOM.el = el;
			this.DOM.items = Array.from(this.DOM.el.querySelectorAll('.slide-item-2 div.product-item-image'));
...
const DOM = {};
  DOM.gridElems = Array.from(document.querySelectorAll('.slide-item-2'));
