...
<div id="_desktop_currency_selector">
  <div class="currency-selector dropdown js-dropdown selection-options-wrapper">
    <label class="hidden">{l s='Currency' d='Shop.Theme'}</label>
    {foreach from=$currencies item=currency}
    {if $currency.current}
    <span class="line-selected hidden">{$currency.sign} {$currency.iso_code}<i class="pe-7s-angle-down arrow-select"></i></span>
    {/if}
    {/foreach}
