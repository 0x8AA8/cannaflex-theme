<div class="lablistproducts  labnewsmartblog col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class='title_block'>
		<h4>
			<span>{l s='Latest News' d='Modules.Smartbloghomelatestnews.Shop'}</span>
		</h4>
	</div>
	<a class="blogviewMore" href="{smartblog::GetSmartBlogLink('smartblog')}">
		<span>{l s='View More Blogs >>' d='Modules.Smartbloghomelatestnews.Shop'}</span>
	</a>
    <div class="row">
            ...
            {foreach from=$view_data item=post}
                    ...
                    <div class="item-inner">
						<div class="item-i">
							...
							<div class="post-info">
								...
								<span class="date_added">{$post.date_added|truncate:10:''}</span>
								 ...
								 {assign var="catOptions" value=null}
											 ...
											 <span>
									   {l s='Posted by ' d='Modules.Smartbloghomelatestnews.Shop'} {if $smartshowauthor ==1}&nbsp;<i class="icon icon-user"></i><span itemprop="author">{if $smartshowauthorstyle != 0}{$firstname} {$lastname}{else}{$lastname} {$firstname}{/if}</span>&nbsp;<i class="icon icon-calendar"></i>&nbsp;<span itemprop="dateCreated">{$created|date_format}</span>{/if}&nbsp;&nbsp;<i class="icon icon-tags"></i>&nbsp;<span itemprop="articleSection"><a href="{smartblog::GetSmartBlogLink('smartblog_category',$catOptions)}">{$title_category}</a></span> &nbsp;<i class="icon icon-comments"></i>&nbsp; {if $countcomment != ''}{$countcomment}{else}{l s='0' d='Modules.Smartbloghomelatestnews.Shop'}{/if}{l s=' Comments' d='Modules.Smartbloghomelatestnews.Shop'}</span>
							...
							<a href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}" title="{l s='See more' d='Modules.Smartbloghomelatestnews.Shop'}"  class="r_more">{l s='See more' d='Modules.Smartbloghomelatestnews.Shop'}<i class="fa fa-angle-double-right"></i></a>
						</div>
                    </div>
