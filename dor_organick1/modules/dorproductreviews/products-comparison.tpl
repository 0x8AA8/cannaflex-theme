...
<tr class="comparison_header">
	<td>
		{l s='Comments' d='Modules.Dorproductreviews.Shop'}
	</td>
...
{/foreach}
	...
	{cycle values='comparison_feature_odd,comparison_feature_even' assign='classname'}
<tr>
	<td  class="{$classname} comparison_infos">{l s='Average' d='Modules.Dorproductreviews.Shop'}</td>
{foreach from=$list_ids_product item=id_product}
...
<tr>
	...
	<td  width="{$width}%" class="{$classname} comparison_infos" align="center" >
		...
		<a href="#" rel="#comments_{$id_product}" class="cluetip">{l s='view comments' d='Modules.Dorproductreviews.Shop'}</a>
