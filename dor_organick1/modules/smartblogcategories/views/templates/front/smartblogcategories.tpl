...
<div id="category_blog_block_left"  class="block blogModule boxPlain">
  <div class="section-title"><h2 class="title_block"><a href="{smartblog::GetSmartBlogLink('smartblog_list')}">{l s='Categories' d='Modules.Smartblogcategories.Shop'}</a></h2></div>
