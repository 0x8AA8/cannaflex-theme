...
<!-- ===== HERO BANNER ===== -->
<section class="activity-hero" aria-labelledby="activity-hero-heading">
    <div class="container">
        <?php
        $intro_heading = get_post_meta($page_id, '_cfx_activity_intro_heading', true);
        ?>
        <h1 id="activity-hero-heading"><?php echo esc_html($intro_heading ?: "From Cultivation to Global Distribution \u{2014} We Cover the Full Cannabis Value Chain"); ?></h1>
        <?php
